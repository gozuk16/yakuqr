...
**Files:**
- Create: `ios/yakuqr-ios.xcodeproj/`
- Create: `ios/yakuqr-ios/`
- Create: `ios/yakuqr-iosTests/`
...
- [ ] **Step 5: .gitignore にXcodeアーティファクトを追加**
  ...
  ios/yakuqr-ios.xcodeproj/xcuserdata/
  ios/yakuqr-ios.xcodeproj/project.xcworkspace/xcuserdata/
  ios/DerivedData/
  ```
...
- [ ] **Step 6: 空ビルドが通ることを確認**
  ...
  ```bash
  xcodebuild build \
    -project ios/yakuqr-ios.xcodeproj \
    -scheme yakuqr-ios \
    -sdk iphonesimulator \
...
**Files:**
- Create: `ios/yakuqr-ios/JAHIS/JAHISModels.swift`

- [ ] **Step 1: JAHISModels.swift を作成**

  `ios/yakuqr-ios/JAHIS/JAHISModels.swift`：
  ```swift
...
- [ ] **Step 4: コミット**
  ...
  ```bash
  git add ios/yakuqr-ios/JAHIS/JAHISModels.swift
...
**Files:**
- Create: `ios/yakuqr-ios/JAHIS/JAHISParser.swift`
- Create: `ios/yakuqr-iosTests/JAHISTests/JAHISParserTests.swift`
...
- [ ] **Step 1: テストファイルを作成（失敗を確認するためのスケルトン）**
  ...
  `ios/yakuqr-iosTests/JAHISTests/JAHISParserTests.swift`：
  ```swift
  import XCTest
...
- [ ] **Step 3: JAHISParser.swift を実装**
  ...
  `ios/yakuqr-ios/JAHIS/JAHISParser.swift`：
  ```swift
  struct JAHISParser {
...
- [ ] **Step 5: コミット**
  ...
  ```bash
  git add ios/yakuqr-ios/JAHIS/JAHISParser.swift \
          ios/yakuqr-iosTests/JAHISTests/JAHISParserTests.swift
...
**Files:**
- Create: `ios/yakuqr-ios/JAHIS/JAHISValidator.swift`
- Create: `ios/yakuqr-iosTests/JAHISTests/JAHISValidatorTests.swift`

**背景:** Go実装（`pkg/validator/`）の移植。Ver.4 はレコード1に患者情報、レコード201以上に薬品情報。Ver.2/3 はレコード2に患者情報、レコード6に薬品情報。

- [ ] **Step 1: テストファイルを作成**

  `ios/yakuqr-iosTests/JAHISTests/JAHISValidatorTests.swift`：
  ```swift
  import XCTest
  @testable import yakuqr_ios
...
- [ ] **Step 3: JAHISValidator.swift を実装**
  ...
  `ios/yakuqr-ios/JAHIS/JAHISValidator.swift`：
  ```swift
...
- [ ] **Step 5: コミット**
  ...
  ```bash
  git add ios/yakuqr-ios/JAHIS/JAHISValidator.swift \
          ios/yakuqr-iosTests/JAHISTests/JAHISValidatorTests.swift
...
**Files:**
- Create: `ios/yakuqr-ios/JAHIS/PrescriptionTextFormatter.swift`
- Create: `ios/yakuqr-iosTests/JAHISTests/PrescriptionTextFormatterTests.swift`

**背景:** Go実装（`pkg/output/output.go` の `BuildText`）に対応。エラー時でも生QR文字列＋エラー内容を必ず含める。

- [ ] **Step 1: テストファイルを作成**

  `ios/yakuqr-iosTests/JAHISTests/PrescriptionTextFormatterTests.swift`：
  ```swift
  import XCTest
  @testable import yakuqr_ios
...
- [ ] **Step 3: PrescriptionTextFormatter.swift を実装**
  ...
  `ios/yakuqr-ios/JAHIS/PrescriptionTextFormatter.swift`：
  ```swift
...
- [ ] **Step 5: コミット**
  ...
  ```bash
  git add ios/yakuqr-ios/JAHIS/PrescriptionTextFormatter.swift \
          ios/yakuqr-iosTests/JAHISTests/PrescriptionTextFormatterTests.swift
...
**Files:**
- Create: `ios/yakuqr-ios/Features/Scanner/CameraService.swift`
- Create: `ios/yakuqr-ios/Features/Scanner/CameraPreviewView.swift`
...
- [ ] **Step 1: CameraService.swift を作成**
  ...
  `ios/yakuqr-ios/Features/Scanner/CameraService.swift`：
  ```swift
  import AVFoundation
  import Combine
...
- [ ] **Step 2: CameraPreviewView.swift を作成**
  ...
  `ios/yakuqr-ios/Features/Scanner/CameraPreviewView.swift`：
  ```swift
  import SwiftUI
  import AVFoundation
...
- [ ] **Step 4: コミット**
  ...
  ```bash
  git add ios/yakuqr-ios/Features/Scanner/CameraService.swift \
          ios/yakuqr-ios/Features/Scanner/CameraPreviewView.swift
...
- [ ] **Step 2: ScannerViewModel のユニットテストを追加**
  ...
  `ios/yakuqr-iosTests/JAHISTests/ScannerViewModelTests.swift`（テストターゲットに追加）：
  ```swift
  import XCTest
  @testable import yakuqr_ios
...
- [ ] **Step 4: コミット**
  ...
  ```bash
  git add ios/yakuqr-ios/Features/Scanner/ScannerViewModel.swift \
          ios/yakuqr-iosTests/JAHISTests/ScannerViewModelTests.swift
...
**Files:**
- Create: `ios/yakuqr-ios/Features/Result/ShareSheet.swift`
- Create: `ios/yakuqr-ios/Features/Result/ResultViewModel.swift`
- Create: `ios/yakuqr-ios/Features/Result/ResultView.swift`

- [ ] **Step 1: ShareSheet.swift を作成**

  `ios/yakuqr-ios/Features/Result/ShareSheet.swift`：
  ```swift
  import SwiftUI
...
- [ ] **Step 3: ResultViewModel.swift を作成**
  ...
  `ios/yakuqr-ios/Features/Result/ResultViewModel.swift`：
  ```swift
  import Foundation
...
- [ ] **Step 4: ResultView.swift を作成**
  ...
  `ios/yakuqr-ios/Features/Result/ResultView.swift`：
  ```swift
  import SwiftUI
...
- [ ] **Step 6: コミット**
  ...
  ```bash
  git add ios/yakuqr-ios/Features/Result/ShareSheet.swift \
          ios/yakuqr-ios/Features/Result/ResultViewModel.swift \
          ios/yakuqr-ios/Features/Result/ResultView.swift
...
**Files:**
- Create: `ios/yakuqr-ios/Features/Scanner/ScannerView.swift`

- [ ] **Step 1: ScannerView.swift を作成**

  `ios/yakuqr-ios/Features/Scanner/ScannerView.swift`：
  ```swift
  import SwiftUI
  import PhotosUI
...
- [ ] **Step 3: コミット**
  ...
  ```bash
  git add ios/yakuqr-ios/Features/Scanner/ScannerView.swift
...
**Files:**
- Modify: `ios/yakuqr-ios/App/YakuqrApp.swift`
- Modify: `ios/yakuqr-ios/App/ContentView.swift`

- [ ] **Step 1: YakuqrApp.swift を更新**

  `ios/yakuqr-ios/App/YakuqrApp.swift`：
  ```swift
  import SwiftUI
...
- [ ] **Step 2: ContentView.swift を更新**
  ...
  `ios/yakuqr-ios/App/ContentView.swift`：
  ```swift
  import SwiftUI
...
- [ ] **Step 5: コミット**
  ...
  ```bash
  git add ios/yakuqr-ios/App/YakuqrApp.swift \
          ios/yakuqr-ios/App/ContentView.swift
